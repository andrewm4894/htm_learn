...
if __name__ == "__main__":
  ...
  parser.add_argument("-d", "--detectors",
                    ...
                    default=["null", "numenta", "random", "skyline",
                             ...
                             "relativeEntropy","windowedAverage"],
  ...
  if "windowedAverage" in args.detectors:
    from nab.detectors.average.windowedAverage_detector import (
      WindowedAverageDetector)
  ...
  if "previousValue" in args.detectors:
    from nab.detectors.previous_value.previousValue_detector import (
    PreviousValueDetector )
